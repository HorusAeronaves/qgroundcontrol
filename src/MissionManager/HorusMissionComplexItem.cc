...
QGC_LOGGING_CATEGORY(HorusMissionComplexItemLog, "HorusMissionComplexItemLog")

const char* HorusMissionComplexItem::jsonComplexItemTypeValue = "fwLandingPattern";

const char* HorusMissionComplexItem::_loiterToLandDistanceName =    "Landing distance";
const char* HorusMissionComplexItem::_landingHeadingName =          "Landing heading";
const char* HorusMissionComplexItem::_loiterAltitudeName =          "Loiter altitude";
const char* HorusMissionComplexItem::_loiterRadiusName =            "Loiter radius";
const char* HorusMissionComplexItem::_landingAltitudeName =         "Landing altitude";

const char* HorusMissionComplexItem::_jsonLoiterCoordinateKey =         "loiterCoordinate";
const char* HorusMissionComplexItem::_jsonLoiterRadiusKey =             "loiterRadius";
const char* HorusMissionComplexItem::_jsonLoiterClockwiseKey =          "loiterClockwise";
const char* HorusMissionComplexItem::_jsonLoiterAltitudeRelativeKey =   "loiterAltitudeRelative";
const char* HorusMissionComplexItem::_jsonLandingCoordinateKey =        "landCoordinate";
const char* HorusMissionComplexItem::_jsonLandingAltitudeRelativeKey =  "landAltitudeRelative";

QMap<QString, FactMetaData*> HorusMissionComplexItem::_metaDataMap;

HorusMissionComplexItem::HorusMissionComplexItem(Vehicle* vehicle, QObject* parent)
...
{
    _editorQml = "qrc:/qml/HorusMissionPatternEditor.qml";

    if (_metaDataMap.isEmpty()) {
        _metaDataMap = FactMetaData::createMapFromJsonFile(QStringLiteral(":/json/HorusMissionPattern.FactMetaData.json"), NULL /* metaDataParent */);
    }
    ...
    connect(&_loiterAltitudeFact,       &Fact::valueChanged,                                    this, &HorusMissionComplexItem::_updateLoiterCoodinateAltitudeFromFact);
    connect(&_landingAltitudeFact,      &Fact::valueChanged,                                    this, &HorusMissionComplexItem::_updateLandingCoodinateAltitudeFromFact);

    connect(&_landingDistanceFact,      &Fact::valueChanged,                                    this, &HorusMissionComplexItem::_recalcFromHeadingAndDistanceChange);
    connect(&_landingHeadingFact,       &Fact::valueChanged,                                    this, &HorusMissionComplexItem::_recalcFromHeadingAndDistanceChange);

    connect(&_loiterRadiusFact,         &Fact::valueChanged,                                    this, &HorusMissionComplexItem::_recalcFromRadiusChange);
    connect(this,                       &HorusMissionComplexItem::loiterClockwiseChanged,   this, &HorusMissionComplexItem::_recalcFromRadiusChange);

    connect(this,                       &HorusMissionComplexItem::loiterCoordinateChanged,  this, &HorusMissionComplexItem::_recalcFromCoordinateChange);
    connect(this,                       &HorusMissionComplexItem::landingCoordinateChanged, this, &HorusMissionComplexItem::_recalcFromCoordinateChange);

    connect(&_loiterAltitudeFact,       &Fact::valueChanged,                                            this, &HorusMissionComplexItem::_setDirty);
    connect(&_landingAltitudeFact,      &Fact::valueChanged,                                            this, &HorusMissionComplexItem::_setDirty);
    connect(&_landingDistanceFact,      &Fact::valueChanged,                                            this, &HorusMissionComplexItem::_setDirty);
    connect(&_landingHeadingFact,       &Fact::valueChanged,                                            this, &HorusMissionComplexItem::_setDirty);
    connect(&_loiterRadiusFact,         &Fact::valueChanged,                                            this, &HorusMissionComplexItem::_setDirty);
    connect(this,                       &HorusMissionComplexItem::loiterCoordinateChanged,          this, &HorusMissionComplexItem::_setDirty);
    connect(this,                       &HorusMissionComplexItem::landingCoordinateChanged,         this, &HorusMissionComplexItem::_setDirty);
    connect(this,                       &HorusMissionComplexItem::loiterClockwiseChanged,           this, &HorusMissionComplexItem::_setDirty);
    connect(this,                       &HorusMissionComplexItem::loiterAltitudeRelativeChanged,    this, &HorusMissionComplexItem::_setDirty);
    connect(this,                       &HorusMissionComplexItem::landingAltitudeRelativeChanged,   this, &HorusMissionComplexItem::_setDirty);
}

int HorusMissionComplexItem::lastSequenceNumber(void) const
{
    // land start, loiter, land
    return _sequenceNumber + 2;
}

void HorusMissionComplexItem::setDirty(bool dirty)
{
    if (_dirty != dirty) {
        _dirty = dirty;
...
void HorusMissionComplexItem::save(QJsonArray&  missionItems)
{
...
void HorusMissionComplexItem::setSequenceNumber(int sequenceNumber)
{
...
bool HorusMissionComplexItem::load(const QJsonObject& complexObject, int sequenceNumber, QString& errorString)
{
...
double HorusMissionComplexItem::greatestDistanceTo(const QGeoCoordinate &other) const
{
    return qMax(_loiterCoordinate.distanceTo(other),_landingCoordinate.distanceTo(other));
}

bool HorusMissionComplexItem::specifiesCoordinate(void) const
{
    return true;
}

void HorusMissionComplexItem::appendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
...
bool HorusMissionComplexItem::scanForItem(QmlObjectListModel* visualItems, Vehicle* vehicle)
{
    qCDebug(HorusMissionComplexItemLog) << "HorusMissionComplexItem::scanForItem count" << visualItems->count();
    ...
    HorusMissionComplexItem* complexItem = new HorusMissionComplexItem(vehicle, visualItems);
...
double HorusMissionComplexItem::complexDistance(void) const
{
    return _loiterCoordinate.distanceTo(_landingCoordinate);
}

void HorusMissionComplexItem::setLandingCoordinate(const QGeoCoordinate& coordinate)
{
...
void HorusMissionComplexItem::setLoiterCoordinate(const QGeoCoordinate& coordinate)
{
...
double HorusMissionComplexItem::_mathematicAngleToHeading(double angle)
{
...
double HorusMissionComplexItem::_headingToMathematicAngle(double heading)
{
    return heading - 90 * -1;
}

void HorusMissionComplexItem::_recalcFromRadiusChange(void)
{
    // Fixed:
    //      land
    //      loiter tangent
...
void HorusMissionComplexItem::_recalcFromHeadingAndDistanceChange(void)
{
    // Fixed:
    //      land
    //      heading
...
QPointF HorusMissionComplexItem::_rotatePoint(const QPointF& point, const QPointF& origin, double angle)
{
    QPointF rotated;
...
void HorusMissionComplexItem::_recalcFromCoordinateChange(void)
{
    // Fixed:
    //      land
    //      loiter
...
void HorusMissionComplexItem::_updateLoiterCoodinateAltitudeFromFact(void)
{
    _loiterCoordinate.setAltitude(_loiterAltitudeFact.rawValue().toDouble());
}

void HorusMissionComplexItem::_updateLandingCoodinateAltitudeFromFact(void)
{
    _landingCoordinate.setAltitude(_landingAltitudeFact.rawValue().toDouble());
}

void HorusMissionComplexItem::_setDirty(void)
{
    setDirty(true);
}

void HorusMissionComplexItem::applyNewAltitude(double newAltitude)
{
