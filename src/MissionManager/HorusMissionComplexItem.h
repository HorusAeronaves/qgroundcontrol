...
#ifndef HorusMissionComplexItem_H
#define HorusMissionComplexItem_H
...
Q_DECLARE_LOGGING_CATEGORY(HorusMissionComplexItemLog)

class HorusMissionComplexItem : public ComplexMissionItem
{
    Q_OBJECT

public:
    HorusMissionComplexItem(Vehicle* vehicle, QObject* parent = NULL);
    ...
    QString             mapVisualQML        (void) const final { return QStringLiteral("HorusMissionPatternMapVisual.qml"); }
