    ...
    Item {
        ...
        Image {
            ...
            transform: Rotation {
                ...
                axis { x: 0; y: 0; z: 1 } angle: _headingWind + 180
            }
            x: Math.sin(- _headingWind*Math.PI / 180 + Math.PI)*(borderRect.height / 2 - windPointer.height / 1.5) + borderRect.width / 2 - windPointer.width / 2
            y: Math.cos(- _headingWind*Math.PI / 180 + Math.PI)*(borderRect.height / 2 - windPointer.height / 1.5) + borderRect.height / 2 - windPointer.height / 2
            z: pointer.z + 1
        }
